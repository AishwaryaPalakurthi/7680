...
public class StudentController 
{
	...
	@GetMapping("/check")
	public ResponseEntity<StudentDTO> login(@RequestParam("studentEmail") String  studentEmail,
			                                @RequestParam("password") String studentPassword)
	{
		
		
		StudentDTO checkedLogin = this.studentService.checkLogin(studentEmail, studentPassword);
		return new ResponseEntity<StudentDTO>(checkedLogin,HttpStatus.OK);
	}
}